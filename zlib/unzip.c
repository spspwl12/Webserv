...
extern unzFile ZEXPORT unzOpen3(const char* buf,
    int size) {
    unz64_s us;
    unz64_s* s;
    ZPOS64_T central_pos;
    ...
    us.z_filefunc.zseek32_file = NULL;
    us.z_filefunc.ztell32_file = NULL;
    fill_fopen64_binary(&us.z_filefunc.zfile_func64);
...
extern unzFile ZEXPORT unzOpenBinary(const void* buf, int size) {
    return unzOpen3(buf, size);
}
